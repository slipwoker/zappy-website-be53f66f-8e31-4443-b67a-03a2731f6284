    ...
    function getErrorMessage(field, errorType) {
      const label = field.closest('.form-group, .field-wrapper, label')
        ? (field.closest('.form-group, .field-wrapper')
            ...
            : null)
        : null;
      const fieldName = label ? label.textContent.trim() : (field.getAttribute('placeholder') || field.name || 'This field');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בדיקות ראייה בבית לגיל השלישי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'be53f66f-8e31-4443-b67a-03a2731f6284',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'be53f66f-8e31-4443-b67a-03a2731f6284';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'be53f66f-8e31-4443-b67a-03a2731f6284';
